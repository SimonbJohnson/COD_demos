...
var demo2Data = [
	...
	["2020-07-24T14:10:04.600+01:00", "2020-07-24T14:10:22.560+01:00", "health", "BRC", "20000",-2.33,12.34, "112850970", "7d6a83f7-0137-4a68-95b5-aa30cd833be1", "2020-07-24T13:10:32","","","","","",""],
	["2020-07-24T14:10:22.612+01:00", "2020-07-24T14:10:45.978+01:00", "shelther", "BRC", "50000",-3.7997453,12.2381364, "112851009", "e8e0f6b7-6d4c-42f4-a7bb-58d8b9eb7e8e", "2020-07-24T13:10:56","","","","","",""],
	["2020-07-24T14:10:46.027+01:00", "2020-07-24T14:11:08.345+01:00", "health", "ARC", "10000",-3.870792,10.2232773, "112851071", "b7c6e3ff-87c7-4d82-b2f4-0012a63e046c", "2020-07-24T13:11:19","","","","","",""]
]
...
function getAdmin(lat,lon,row){
	...
	let url = 'https://beta.itos.uga.edu/CODV2API/api/v1/Themes/cod-ab/Lookup/latlng?latlong={{lat}},{{lon}}&wkid=4326&level=3';
...
function updateTable(response,row){
	let updates = [
		...
		{'source':'admin3Name_local','target':'demo2datarow{{row}}cell14'},
		{'source':'admin1Pcode','target':'demo2datarow{{row}}cell11'},
		{'source':'admin2Pcode','target':'demo2datarow{{row}}cell13'},
		{'source':'admin3Pcode','target':'demo2datarow{{row}}cell15'}
	];
...
function mapcreate3(data){
	...
	map3 = L.map('map3').setView([12,-1.5], 6); // africa
...
function loadDemo3Data(url){
	let dataURL = 'https://proxy.hxlstandard.org/data.json?dest=data_edit&filter01=count&count-tags01=%23adm1%2Bcode&count-type01-01=sum&count-pattern01-01=%23reached&count-header01-01=Count&count-column01-01=%23meta%2Bcount&strip-headers=on&url='+url
...
function map4(data){
	...
	var mapTiles = L.vectorGrid.protobuf("https://itos-humanitarian.s3.amazonaws.com/v1/VectorTile/COD_BFA/Admin2/{z}/{x}/{y}.pbf", {
		vectorTileLayerStyles: {
			    'Admin2':function(properties) {
			    	let value = data[properties['admin2Pcode']];
			    	color = '#ffffff'
			    	if(value == undefined){
			    		console.log(properties['admin2Pcode']);
			    	}
			    	if(value>0){
			    		color = '#90CAF9'
			    	}
